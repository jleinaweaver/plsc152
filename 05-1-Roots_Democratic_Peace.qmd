...
## Kant (1798): Perpetual Peace {background-image="libs/Images/background-worldmap4.png" .center .smaller}
...
## Kant (1798) vs Doyle (1983) {background-image="libs/Images/background-worldmap4.png" .center}
...
## Does this Article advance peace? {background-image="libs/Images/background-worldmap4.png" .center}
...
## Kant (1798) vs Doyle (1983) {background-image="libs/Images/background-worldmap4.png" .center .smaller}
...
## Kant's Preliminary Articles {background-image="libs/Images/background-worldmap4.png" .center .smaller}
