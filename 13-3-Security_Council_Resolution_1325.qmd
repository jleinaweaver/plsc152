...
3. **SAVE TIME AT THE END OF CLASS TO DIAGRAM FEMINIST THEORY AS A CLASS: INTERESTS, INSTITUTIONS AND INTERACTIONS**
    - They don't have to crack it but they need to get started on it in a meaningful way today
    - CONSIDER adding a slide to encourage them to think about their cases from Monday (e.g. intl political events that have gone under-investigated/explained), Enloe's arguments from Wednesday (e.g. where does power lie? how do the rules actually work? whose roles in history are acknowledged and celebrated?), today's research on the UN's efforts to solve problems in resolution 1325
    - That means YOU need a clearer idea of what a good diagram looks like
...
## Nadine Puechguirbal, PhD {background-image="libs/Images/background-worldmap4.png" .center .smaller}

:::: {.columns}
::: {.column width="50%"}
![](libs/Images/13-3-author_photo.jpg){.absolute width='3.5in' height='5in'}
:::
...
## {background-image="libs/Images/13-3-unsc_r_1325.png"}
...
## {background-image="libs/Images/13-3-unsc_r_1325_described2.png" background-size='83%'}
...
## {background-image="libs/Images/13-3-sponge_bob-only-if-you-ask-nicely.jpg" background-size='68%'}
...
## {background-image="libs/Images/13-3-Abstract.png" background-size='75%'}
...
## Puechguirbal's (2010) Argument {background-image="libs/Images/background-blue_cubes_lighter3.png" .center}
