...
## Farrell's (2010) Writing Advice {background-image="libs/Images/background-worldmap4.png" .center}
...
## To be convincing an argument should be logical, clear, credible and critical {background-image="libs/Images/background-worldmap4.png" .center}
...
## The "best" premises are... {background-image="libs/Images/background-worldmap4.png" .center}
...
**Find an international political event that you find interesting and would like to explore more deeply. Your first paper must make an argument that it is important we understand why this event happened.**
...
## Next Class {background-image="libs/Images/background-blue_triangles2.png" .center .smaller}
