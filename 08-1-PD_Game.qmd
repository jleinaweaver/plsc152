...
# Today's Agenda {background-image="libs/Images/background-worldmap4.png"}
...
## So far in this class we've... {background-image="libs/Images/background-cloth_v3.png" .center}
...
## Make an argument that one of the IR theories we've studied in class so far this term **"best"** explains the event you explored in Paper 1 {background-image="libs/Images/background-cloth_v3.png" .center}
...
## Semester Outline {background-image="libs/Images/background-cloth_v3.png" .center}
...
## Assignment for Next Class {background-image="libs/Images/background-cloth_v3.png" .center}
