...
## So far in this class we've... {background-image="Images/background-cloth_v3.png" .center}
...
## Make an argument that one of the IR theories we've studied in class so far this term **"best"** explains the event you explored in Paper 1 {background-image="Images/background-cloth_v3.png" .center}

<br>

```{r, fig.align='center', out.width='100%'}
knitr::include_graphics("Images/03_1-syllabus.png")
```
...
## Semester Outline {background-image="Images/background-cloth_v3.png" .center}
...
## Assignment for Next Class {background-image="Images/background-cloth_v3.png" .center}

<br>

```{r, fig.align='center', out.width='100%'}
knitr::include_graphics("Images/08_1-Assignment.png")
```
