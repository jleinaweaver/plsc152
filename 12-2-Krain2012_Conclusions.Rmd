...
.size40[.center[**Naming and shaming works? .textred[High, low or no] confidence?**]]

<br>

.size40[**Groups: 1. NGOs, 2. Northern media, 3. IOs**]

.size40[
Evaluate the:

+ Case selections
+ Operationalization & measurement of the outcome
+ Operationalization & measurement of the key predictors
+ Regression results in Tables 3 and 4
]

???

We'll work through these elements of the analysis in small groups.
...
```{r, fig.retina=3, fig.align='center', out.width='93%'}
...
Groups, evaluate the case selection as it impacts our level of confidence in the three conclusions.

* Report Back *

<br>

HOW DOES THE CASE SELECTION IN THIS PAPER IMPACT OUR LEVEL OF CONFIDENCE IN THE THREE CONCLUSIONS?

- HOW DID KRAIN SELECT HIS CASES?

- DOES THAT PROCESS IMPACT OUR THREE CONCLUSIONS DIFFERENTLY? WHY OR WHY NOT?

(Big variation in attention paid by "northern" media to different countries around the world, right?)
- Selection bias...
