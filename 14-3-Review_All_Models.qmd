...
## Course Evaluations (IDEA) {background-image="Images/background-worldmap4.png" .center}
...
IFF everyone in class submits their evals for this class I will give everyone EC on the final paper!
...
## Final Exam (Due Dec 10, 10am) {background-image="Images/background-worldmap4.png" .center}
...
:::: {.columns}
::: {.column width="50%"}
- Palestine's Exclusion from the UNGA
- U.S and Vietnam Tariff Deal
- May 2025 meeting between US and Syria
- Brazil seeks to join the IEA
- Insurgency in and around Nigeria
- DPRK alliance with Russia
- The spread of the No Kings protests
- Niger’s withdrawal from the MNJTF
- Trump's tariffs against Brazil
- Bulgaria & Romania join Schengen
- Trump's tariffs on the world
- International punishment for Israel's war
:::

::: {.column width="50%"}
- Israel attacks Iranian nuclear sites
- US attacks Iranian nuclear sites
- Cross-border shootings in Korea
- Israeli airstrikes on Yemen
- Trade deal between DPRK, China & Russia
- The conflict between Rwanda and the DRC
- US strikes on "drug runners" in international waters
- France, Germany, and UK snapback sanctions against Iran
- UAE's involvement in Sudanese Civil War
- US visa restrictions against Palestinians
:::
::::
