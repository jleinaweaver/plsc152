...
## Hopf (1998) Reframes the Question {background-image="libs/Images/background-blue_cubes_lighter3.png" .center}
...
## 1. Actors and Structures are Mutually Constituted {background-image="libs/Images/background-blue_cubes_lighter3.png" .center}
...
## {background-image="libs/Images/13_1-movies.jpg"}
...
## {background-image="libs/Images/11_1-Putin_v_Ukraine.jpg"}
...
## 1. Actors and Structures are Mutually Constituted {background-image="libs/Images/11_1-Putin_v_Ukraine2.png"}
...
## 2. Anarchy as Imagined Community {background-image="libs/Images/background-blue_cubes_lighter3.png"}
...
## 2. Anarchy as Imagined Community {background-image="libs/Images/background-blue_cubes_lighter3.png" .center}
...
## {background-image="libs/Images/13_1-us_canada.jpg"}
...
## {background-image="libs/Images/13_1-korean_border.jpg"}
...
## 3. The Power of Practice {background-image="libs/Images/background-blue_cubes_lighter3.png" .center}
...
## {background-image="libs/Images/13_1-MLK.jpg"}
...
## {background-image="libs/Images/13_1-Gandhi.jpg"}
...
## {background-image="libs/Images/13_1-change.png"}
...
## {background-image="libs/Images/13_1-raphael.png"}
...
## Applying Constructivism to IR Puzzles {background-image="libs/Images/background-blue_cubes_lighter3.png" .center}
...
## {background-image="libs/Images/13_1-security_dilemma.png"}
...
## Economic Liberalism {background-image="libs/Images/background-blue_cubes_lighter3.png" .center .smaller}
...
## Constructivism (Hopf 1998) {background-image="libs/Images/background-blue_cubes_lighter3.png" .center}
...
What is a "norm entrepreneur" and how does understanding this mechanism help us think about achieving change in international politics?
...
## Neoliberal Cooperation {background-image="libs/Images/background-blue_cubes_lighter3.png" .center}
...
::: {.column width="50%"}
```{r, fig.align='center'}
knitr::include_graphics("libs/Images/07_2-UN_Flag.png")
```
:::
::::
...
## {background-image="libs/Images/13_1-global_peace_index.png"}
