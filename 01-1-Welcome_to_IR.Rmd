...
.size60[
On balance, has the US been a net positive or negative influence on the world over the last 20 years?
]
...
knitr::include_graphics("libs/Images/01_1-assad.jpg")
```
...
.size50[.center[**The Arab Spring**]]

.pull-left[

```{r, fig.align='center', out.width='100%'}
knitr::include_graphics("libs/Images/01_1-arab_spring_gaddafi.jpg")
```
...
```{r, fig.align='center', out.width='100%'}
knitr::include_graphics("libs/Images/01_1-arab_spring_assad.jpg")
```
...
ANYBODY EVER HEARD OF THE ARAB SPRING?

(Dec 2010, protest launched in Tunisia, spreads to Libya and Syria in the spring of 2011)
- people in the streets, demands for change
...
|:-----|:----:|:----:|
|Participation||20|
|Paper 1: Making an Argument|(Sep 19)|20|
|Paper 2: Piazza and Choi (2018) |(Oct 24)|20|
|Paper 3: Young and Carpenter (2018) |(Nov 21)|20|
|Final Exam||20|
||||
|TOTAL||100|
