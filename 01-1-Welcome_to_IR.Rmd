...
background-image: url('libs/Images/background-worldmap2.png')
background-size: 100%
background-class: center
class: middle, center
...
Round 2 gets tougher!



---

background-image: url('libs/Images/01_1-gaddafi2.jpg')
background-size: 100%
background-class: center
...
background-image: url('libs/Images/01_1-Assad2.webp')
background-size: 100%
background-class: center
...
### Who is this handsome fella pictured here with his wife?
+ (Bashar al-Assad)
...
These two "gentlemen" offer us an excellent example of the kinds of puzzles international relations tries to explain.
...
In the winter of 2010 a popular protest launched in Tunisia against the autocractic government.

These protests caught fire across the Middle East.

People poured into the streets making demands for change and accountability.

This has come to be referred to as the Arab Spring.

### Has anybody heard of the Arab Spring? Know anything about it?
...
Global response has been... lacklustre

In the Syrian case, al-Assad waged a brutal war against his own people and is now winning.

At this point Assad has basically won.



---

background-image: url('libs/Images/01_1-assad_voting.jpg')
background-size: 100%
background-class: center

???

In international relations we love puzzles like this.

I won't show you what happened to Gaddafi, but let's just say the people were mad and they took it out on him.

On the other hand, here we see Assad voting for himself in the recent election wherein he won 95.1% of the vote on a turnout of 78.66%! [Link](https://www.dw.com/en/syria-election-results-bashar-assad-wins-4th-term/a-57695135)

A pretty impressive result after ruling during a war that killed above 500k!

Also, let's be honest, the ".1%" is just insulting. You're not fooling anyone with that.

<br>

### Why did two brutal dictators, reacting to the same peaceful protests with extreme violence reach such different ends?
...
background-image: url('libs/Images/01-1-world_map-ME.png')
background-size: 84%
background-class: center
...
### So, do you believe either conflict represents a threat to us? why or why not?

+ (worries about terrorism spreading)

+ (Syria is already in an incredibly unfriendly spot to us, deeply chaotic with lots of players)

+ (Libya chaos sends migrants across the Mediterranean to Europe!)
...
I told you about Gaddafi's made-up titles, right?

+ The "King of African Kings" had alienated everybody.

<br>

On the other hand, Assad is protected and defended by the Russians and the Iranians.
...
### Are you persuaded by Assad's argument here? Why or why not?
...
Ok, in broad strokes that's what IR scholars try to do.

### Any questions on the big picture?
...
I would REALLY like us to kick off class most days with current events.

But that will require YOU to make an effort to follow global news!
...
background-image: url('libs/Images/01-1-Moodle.png')
background-size: 95%
class: center
...
ALL of the assigned readings are available on Moodle.

I have given you web links for many of them in the syllabus BUT if those ever don't work the READINGS are ON MOODLE!
...
2. Antonov, Anatoly. (2021, Dec 30). An Existential Threat to Europe’s Security Architecture? *Foreign Policy*. [Link](https://foreignpolicy.com/2021/12/30/russia-ukraine-nato-threat-security/)

3. Chausovsky, Eugene. (2021, Dec 27). How Russia Decides When to Invade. *Foreign Policy*. [Link](https://foreignpolicy.com/2021/12/27/how-russia-decides-when-to-invade/)
]
...
Labossiere gives us the basic concepts we need to analyze arguments.

Antonov is the Russian Ambassador to the US and here he lays out Russia's position on Ukraine.

Chausovsky is a researcher studying Russian foreign policy.
