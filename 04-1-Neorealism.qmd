...
## Scientific Method {background-image="libs/Images/background-blue_triangles2.png" .center}
...
## The Outcome to Explain {background-image="libs/Images/background-worldmap4.png" .center .smaller}
...
## {background-image="libs/Images/06_1-WW1.jpg" .center}
...
## {background-image="libs/Images/06_1-WW1-2.jpg" .center}
...
## Section 2: Why Are There Wars? {background-image="libs/Images/background-worldmap4.png" .center}
...
## The Realist Paradigm {background-image="libs/Images/05_2-putin_with_gun_v1.png"}
...
## {background-image="libs/Images/background-space1.jpg" .center}
...
## Frieden, Lake and Schultz (2016) {background-image="libs/Images/background-worldmap4.png" .center}
...
## Frieden, Lake and Schultz (2016) {background-image="libs/Images/background-worldmap4.png" .center .smaller}
...
## Neorealism {background-image="libs/Images/05_2-putin_with_gun_v2.png" .center}
...
## Neorealism {background-image="libs/Images/background-slate_v2.png" .center}
...
## The Security Dilemma {background-image="libs/Images/02_3-neighbors_v1.png"}
...
## The Security Dilemma {background-image="libs/Images/background-worldmap4.png" .center}
...
::: {.column width="50%"}
```{r, fig.align='right'}
knitr::include_graphics("libs/Images/02_3-dog_hatchet_v1.png")
```
:::
::::
...
::: {.column width="50%"}
```{r, fig.align='left'}
knitr::include_graphics("libs/Images/04_1-Tank_v1.png")
```
:::
...
::: {.column width="50%"}
```{r, fig.align='right'}
knitr::include_graphics("libs/Images/04_1-angry_bear.jpg")
```
:::
::::
