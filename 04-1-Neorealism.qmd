...
2. Make sure to keep things moving to cover all exercises. Tons to do so skip current events talk
...
**SLIDE**: Reminder, your first paper is due on Friday!
...
**Is everybody confident they have selected a SINGLE, DISTINCT international political event for the paper?**

<br>

**Is everybody confident they have an outline with THREE DISTINCT premises? e.g. making separate points!**

<br>

**Is everyone confident that there argument makes clear their chosen event is of GLOBAL importance and not just huge importance to one or two states?**

- Keep the paper prompt in mind!

- Your argument is that this is the most important INTERNATIONAL event

<br>

**Does everybody have a good idea for their counter-argument paragraph?**

<br>

**IMPORTANT: Has everybody read the requirements for argument papers in the syllabus?**

- e.g. minimum word count, citation styles, lateness penalty, etc
