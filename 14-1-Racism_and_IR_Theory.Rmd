...
- Those focusing on the intersections of race and international political events.

<br>

Why include "postcolonialism" theories here?
- One of the real strengths of the critical IR theories is they  take seriously the experiences of people in the non-western or less developed parts of the world.
...
.size65[**The Fragile States Index (The Fund for Peace 2021)**]
...
background-image: url('libs/Images/14-1-Fragile_States-US1.png')
background-size: 100%
background-position: center
...
Here you can see the US position overall.

- Note that higher scores on the fragility index are bad (e.g. becoming a bigger source of instability)

<br>

We're in the "green" category (e.g. middle ground) and the US had the biggest drop in stability of any country they measured last year.
...
background-image: url('libs/Images/14-1-Fragile_States-US2.png')
background-size: 75%
background-position: center
class: middle, slideblue
...
All three of the cohesion indicators are getting much worse (line four is the avg)
...
background-image: url('libs/Images/14-1-race_development.png')
background-size: 33%
background-position: left
...
### Ok, put yourself in the postcolonialist shoes, what is the harm in using Hobbes to build our Realist theories of international relations?
