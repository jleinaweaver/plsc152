...
## {background-image="libs/Images/05_3-Korean_Nukes_v2.png"}
...
## {background-image="libs/Images/05_3-Bolton_and_Trump.webp"}
...
## Argument 2: Sagan and Weiner (2018) {background-image="libs/Images/background-worldmap4.png" .center}

```{r, fig.align='center'}
knitr::include_graphics('libs/Images/06_3-otto_von_bismarck_quote.jpg')
```
...
## {background-image="libs/Images/05_3-DPRK_News.png" .center background-size='73%'}
