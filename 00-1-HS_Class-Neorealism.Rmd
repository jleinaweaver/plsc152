...
**SLIDE**: Intros and plan for today
...
Afternoon All, my name is Dr. Justin Leinaweaver

- Today I want to walk you through some of the basic ground we cover in Introduction to International Relations here at Drury
...
- My research: International environmental policy-making
    - e.g How do we solve big problems at the global level?
    
    
SLIDE: Example from climate change study?



<br>

**SLIDE**: Speaking of Drury...
...
So, long story short, shall we spend an hour introducing, diagramming and analyzing neorealism as an answer to the question "why are there wars?"? Before class I would ask the students to read Ken Waltz's (1988) piece laying out the tenets of neorealism (attached) and in class we'd run through something like:
1. What are "international political events"?
2. What does it mean to study those events "scientifically"?
3. Play a quick "survive or die" game to set up the intuitions of realism 4. Introduce one set of tools for diagramming a model (interests, institutions and interactions) and then use them to unpack Waltz's argument 5. Discuss: Can we connect the security dilemma to current events? Any ongoing political conflicts that neorealism misunderstands? Or fails to explain?
