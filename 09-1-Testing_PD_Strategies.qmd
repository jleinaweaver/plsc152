...
## A Model of the Prisoner's Dilemma {background-image="libs/Images/background-worldmap4.png" .smaller}
...
## Prisoner's Dilemma {background-image="libs/Images/background-worldmap4.png"}
...
- Take a out a piece of paper and make an empty list from 1-10 (with space for your decision each round)
...
- **What strategy or tactics did you try?**
:::



## Prisoner's Dilemma Strategies {background-image="libs/Images/background-worldmap4.png" .center}
...
- *If groups of 5, then one strategy to each person*

- *If groups of 6, then one person records results on board*
...
## Prisoner's Dilemma  {background-image="libs/Images/background-worldmap4.png" .center}
...
::: notes
Groups, your job is to test each of the five strategies against all of the others

- We need to know how many points each strategy is worth when it goes up against each of the other strategies
...
## Shkrum, Natalukha & Vasylenko (2023) {background-image="libs/Images/background-worldmap4.png"}
