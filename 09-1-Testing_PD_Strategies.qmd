...
**SLIDE**: Reminder about paper deadline Friday
...
Your second paper is due on Friday

- And a rough draft must be completed before class on Friday

- **Any questions on the prompt or the draft assignment for Friday?**

<br>

**SLIDE**: Back to the PD

:::



## The Prisoner's Dilemma {background-image="Images/background-worldmap4.png" .center}

![](Images/09_1-PD_Graphic.jpg){style="display: block; margin: 0 auto"}
