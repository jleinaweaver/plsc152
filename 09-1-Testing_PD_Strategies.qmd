...
*When everyone is done, SLIDE for the reporting back*
...
3. Average result across all opponents?

4. How many positive (out of five)?

::: notes

*Collect results on the board*

- *DISCUSS ALL*

<br>

SLIDE: Your version of the table (if needed)
...
tab1 |>
  kbl(col.names = c("Strategy", "Cooperate", "Defect", "Grim Trigger", "Tit for Tat", "Mixed", "Mean", "Minimum", "Maximum", "Positive"), align = c("l", rep("c", 9))) |>
  kable_styling(bootstrap_options = c("striped", "hover"), font_size = 20) |>
  add_header_above(c("", "Opponent's Strategy"= 5, "Results" = 4)) |>
  column_spec(1, background = "lightgrey") |>
  column_spec(2:6, background = "lightyellow") |>
  column_spec(7:10, background = "orange")
