...
## Scientific Method {background-image="Images/background-blue_triangles2.png" .center}
...
::: {.column width="50%"}
```{r, fig.align='right'}
knitr::include_graphics("Images/05_1-science_meme.jpg")
```
:::
::::
...
## Neorealism {background-image="Images/05_2-putin_with_gun_v2.png" .center}
...
## Neorealism {background-image="Images/background-slate_v2.png" .center}
...
::: {.column width="50%"}
```{r, fig.align='left'}
knitr::include_graphics("Images/02_3-Wilson.jpg")
```
:::
...
::: {.column width="50%"}
```{r, fig.align='right'}
knitr::include_graphics("Images/02_3-dog_hatchet_v1.png")
```
:::
::::
...
```{r, fig.align='left'}
knitr::include_graphics("Images/02_3-handgun.jpg")
```
:::
...
::: {.column width="50%"}
```{r, fig.align='right'}
knitr::include_graphics("Images/02_3-wolves.jpg")
```
:::
::::
...
::: {.column width="50%"}
```{r, fig.align='left'}
knitr::include_graphics("Images/04_1-Tank_v1.png")
```
:::
...
::: {.column width="50%"}
```{r, fig.align='right'}
knitr::include_graphics("Images/04_1-angry_bear.jpg")
```
:::
::::
