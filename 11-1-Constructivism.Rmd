...
.size50[.content-box-purple[**Hopf (1998) Reframes the Question**]]
...
**SLIDE**: Let's try to break this into its component parts.
...
.size90[**1. .textred[Actors] and .textgreen[Structures] are .textblue[Mutually] .textorange[Constituted]**]
...
background-image: url('libs/Images/11_1-Putin_v_Ukraine.jpg')
background-size: 100%
class: center
...
background-image: url('libs/Images/11_1-Putin_v_Ukraine2.png')
background-size: 100%
background-position: center
class: top, center

.size70[**1. Actors and Structures are Mutually Constituted**]
...
background-image: url('libs/Images/13_1-us_canada.jpg')
background-size: 100%
background-position: center
class: middle, center
...
background-image: url('libs/Images/13_1-korean_border.jpg')
background-size: 100%
background-position: center
class: middle, center
...
.size55[**3. The Power of Practice**]

.size35[**Criteria to be a Great Power (Waltz 1979)**
...
.size60[.center[**Applying Constructivism to IR Puzzles**]
