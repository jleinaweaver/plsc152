...
## Spring 2024 (11 pairs)
library(tidyverse)

# Record class data 
d <- tibble(
  Version1 = c(3, 3, 3, 3, 3, 4, 1, 3, 4, 3, 4), # 34 total 
  Version2 = c(3, 2, 3, 3, 3, 4, 3, 4, 2, 3, 5), # 35 total 
  Version3 = c(3, 2, 2, 2, 3, 2, 1, 4, 1, 1, 2), # 23 total 
  Version4 = c(0, 0, 0, 0, 1, 1, 2, 1, 3, 3, 3) # 14 total 
)
...
d2 %>%
  ...
  geom_hline(yintercept = seq(2, 20, 2), color = "white")
...
d2 %>%
  ...
  scale_x_continuous(limits = c(-.25,5.25), breaks = seq(0, 5, 1)) +
  geom_hline(yintercept = seq(1, 7, 1), color = "white")
