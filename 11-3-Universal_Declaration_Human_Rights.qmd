...
## {background-image="libs/Images/13_3-Roosevelt.png"}
...
## Classify US Performance on each article in the UN DHR {background-image="libs/Images/background-blue_cubes_lighter3.png" .center}
...
## Should the US enshrine the UN DHR in domestic law? {background-image="libs/Images/background-blue_cubes_lighter3.png" .center}
