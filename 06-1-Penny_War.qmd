...
## Why do wars happen? {background-image="libs/Images/06_1-WW1-2_v2.png"}
...
## The Neorealist Answer {background-image="libs/Images/06_1-neorealist_world_v2.png"}
...
## The Offensive Realist Answer {background-image="libs/Images/background-worldmap4.png"}

```{r, fig.align='center'}
knitr::include_graphics("libs/Images/06_1-Offensive_world.webp")
```
...
## The Democratic Peace Answer {background-image="libs/Images/06_1-ICC_v2.png"}
...
## The Economic Liberal Answer {background-image="libs/Images/06_1-global_rules.jpg"}
...
## The Bargaining Model of War {background-image="libs/Images/background-worldmap4.png"}

```{r, fig.align='center'}
knitr::include_graphics("libs/Images/06_1-kennedy-khruschev2.png")
```
...
## Simulating the Bargaining Model {background-image="libs/Images/background-triangles_grey_v2.png" .center}
...
## {background-image="libs/Images/background-triangles_grey_v2.png"}
