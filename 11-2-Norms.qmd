...
In the excerpt you read for today, Finnemore and Sikkink make the argument that racist norms aren't "bad"

- **What do they mean by that? Are they defending racism?**
...
- What matters is that the group that holds the norm believes it is appropriate. NOT that we approve of it.

- We really want to be careful not to assume norms are somehow linked to objective values of goodness.

<br>

For constructivists, the aim remains focused on explaining international political events

- Doing THAT requires thinking about how community's define rules tied to their identity

- And very often that identity exists in opposition to others

- It's not good or bad, it is an attempt to understand behavior
