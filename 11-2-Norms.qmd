...
## {background-image="libs/Images/13_2-Gandhi2.jpg"}
...
## {background-image="libs/Images/13_2-norm_vs_institution.png"}
...
## {background-image="libs/Images/13_2-slave_auction.png"}
...
## {background-image="libs/Images/13_2-usa.png"}
...
## {background-image="libs/Images/13_2-FSU.png"}
...
## {background-image="libs/Images/13_2-drury.png"}
...
## {background-image="libs/Images/13_2-touchdown.png"}
...
## {background-image="libs/Images/13_2-football2.png"}
...
## {background-image="libs/Images/13_2-obama_cartoon.png" background-size='85%'}
...
## {background-image="libs/Images/13_2-tariffs.png"}
...
## {background-image="libs/Images/11-2-norms_cartoon.jpg"}
...
## {background-image="libs/Images/11-1-totalitarian_leaders.jpg" background-size="75%"}
...
## The Norm Life Cycle {background-image="libs/Images/13_2-norm_life_cycle.png" background-size="92%"}
...
## {background-image="libs/Images/13_2-votes_for_women.png"}
...
## {background-image="libs/Images/13_2-votes_for_women2.png"}
...
knitr::include_graphics("libs/Images/13_2-no_suffrage_list.png")
```
:::
...
## {background-image="libs/Images/11-2-issue_framing.jpg"}
...
## {background-image="libs/Images/13_2-putin_ukraine1.png" background-size="85%"}
...
## {background-image="libs/Images/13_2-putin_ukraine2.png" background-size="73%"}
...
## {background-image="libs/Images/13_2-norm_life_cycle.png" background-size="92%"}
