...
.center[.size70[**Economic Liberalism**]]
...
background-image: url('libs/Images/08-1-car_from_scratch.jpeg')
background-size: 100%
background-position: center
...
### So, why do we describe Economic Liberalism as an example of a Liberal Model of International Relations?

#### - What is it about this model that is "liberal" in the IR sense?
...
background-image: url('libs/Images/08-1-trade_protest.jpg')
background-size: 100%
background-position: center
class: middle
...
Wednesday we shift our exploration of trade onto the costs.
