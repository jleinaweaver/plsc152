...
## {background-image="Images/background-blue_cubes_lighter3.png" .center}
...
```{r, fig.align='center'}
knitr::include_graphics("Images/02_2-mbta_map.png")
```
:::

::: {.column width="50%"}
```{r, fig.align='center'}
knitr::include_graphics("Images/02_2-mbta_map2.png")
```
:::
::::
...
## Assignment for Next Class {background-image="Images/background-blue_triangles2.png" .center .smaller}
