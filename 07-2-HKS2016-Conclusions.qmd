...
```{r, fig.align='center'}
knitr::include_graphics('libs/Images/06_3-diplomacy1.png')
```
...
## Conclusion: The UN succeeds when... {background-image="libs/Images/07_2-UN_Flag2.png" .center}
...
## High, Low or No Confidence? {background-image="libs/Images/07_2-UN_Flag2.png" .center}
...
## {background-image="libs/Images/07_3-Table1.png" background-size='85%'}
...
::: {.column width="50%"}
```{r, fig.align='center'}
knitr::include_graphics('libs/Images/07_3-table2.png')
```
:::
::::
...
## {background-image="libs/Images/07_3-table2-1.png"  background-size='95%'}
...
## {background-image="libs/Images/07_3-table2-2.png"  background-size='95%'}
...
## {background-image="libs/Images/07_3-Figure2.png"  background-size='75%'}
