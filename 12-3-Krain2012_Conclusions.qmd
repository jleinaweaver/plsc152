...
knitr::include_graphics("libs/Images/15_3-Post_Article.png")
```
:::
...
::: {.column width="50%"}
```{r, fig.retina=3, fig.align='right', out.width='100%'}
knitr::include_graphics("libs/Images/15_3-NYT_UN.png")
```
:::
...
## Make an Argument {background-image="libs/Images/background-slate_v2.png" .center}
...
## Krain (2012): Cases {background-image="libs/Images/background-slate_v2.png" .center}
...
## Krain (2012): Outcome {background-image="libs/Images/background-slate_v2.png" .center}
...
## Krain (2012): Predictors {background-image="libs/Images/background-slate_v2.png"}
...
## {background-image="libs/Images/15_3-Appendix.png" background-size='88%'}
...
## {background-image="libs/Images/15_3-regression2.png"}
...
## {background-image="libs/Images/15_3-Table5.png" background-size='88%'}
...
## {background-image="libs/Images/15_3-Table5_news.png" background-size='90%'}
...
## {background-image="libs/Images/15_3-Table5-news2.png"  background-size='88%'}
...
```{r, fig.align='center', fig.asp=.618, cache=TRUE}
# Animate the shift
library(gganimate)
...
## {background-image="libs/Images/15_3-Table6.png" background-size='90%'}
...
## {background-image="libs/Images/15_3-Table8.png" background-size='90%'}
...
## {background-image="libs/Images/12_3-Feminist_Protest.png"}
