...
*Warm-up AND connections to last classes*

- *Use the following to identify a bunch of different current events and evaluate them as "international," "political" and "events"*

- *Aim to do a bunch rather than go deep on one*

<br>

**Ok, what's going on in the world?**

- **Give me an international political event going on in the world right now**
...
- **SLIDE**: On July 20, 1969 the Apollo 11 mission landed on the moon

:::



## {background-image="Images/02_2-moon-landing.avif" .center}

::: notes

The effort to put a man on the moon was a massive national undertaking

- A peak workforce of over 400,000 scientists, engineers, technicians, and managers from various companies and universities worked on the Apollo program.

- A decade of intense work from 1961 to 1969, and

- It required building entirely new systems from scratch, including the powerful Saturn V rocket, and developing new inventions and techniques that later became everyday technologies

    - Fire resistant fabrics, microchips, scratch resistant glasses, cordless tools, water filtration, rechargable hearing aids, and so much more

<br>

So either the US government organized an incredible program of discovery that set the stage for US economic dominance, OR...
...
- The conspiracy involved 400,000 people ALL OF WHOM could keep this massive secret

- We were able to completely fool the Russians who had their own spy program and space program focused on everything we were doing

- We somehow planted a mirror on the moon so experiments can be done from Earth,

- We wrote hundreds of thousands of detailed plans, diagrams, budgets and other documents that currently exist and can be reviewed in archives showing the entirety of the project at every step of its development.
...
**SLIDE**: That brings us back to evaluating theories by their usefulness
