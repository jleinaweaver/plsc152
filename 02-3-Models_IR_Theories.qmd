...
## The "Big" Theories of International Relations {background-image="Images/background-worldmap4.png" .center}
...
1) Identify the **five** most important places on campus, and
...
## {background-image="Images/background-blue_cubes_lighter3.png"}
...
::: {.column width="50%"}
```{r, fig.align='center'}
knitr::include_graphics("Images/02_2-mbta_map3.png")
```
:::
::::
