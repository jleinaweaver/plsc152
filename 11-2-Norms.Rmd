...
### Give me something going on in current events right now that we explain using constructivism!
...
background-image: url('libs/Images/11-2-norms_cartoon.jpg')
background-size: 100%
class: center
...
background-image: url('libs/Images/11-1-totalitarian_leaders.jpg')
background-size: 62%
class: center
...
background-image: url('libs/Images/11-2-issue_framing.jpg')
background-size: 100%
class: center
