...
.size65["Gender Makes the World Go Round: Where are the women?"]
]
]
...
.size50[**Where Does Power Operate? (p8-13)**]
...
background-image: url('libs/Images/13_2-Equity_Now_March.png')
background-size: 90%
background-position: top
class: slideblue, bottom, center

.size45[**Who Takes Seriously the Ideas of Transnational Feminists? (p13-20)**]
...
class: slideblue, center

.size45[**What We Miss: Two Brief Case Studies (p21-28)**]
...
background-image: url('libs/Images/13_2-Stereotypical_gender_roles.jpg')
background-size: 100%
background-position: center
class: slideblue, bottom, center

.content-box-blue[.size60[**Where Are the Men? (p28-32)**]]
...
.content-box-blue[.size60[**Beyond the Global Victim (p32-36)**]]
...
Do our models need to change or do we need an entirely new model focused on gender and IR?
]]]]
...
.size60[.content-box-blue[**Assignment for Friday**]]

<br>

<br>

.center[.size55[Puechguirbal (2010) on Gender Policy in the UN]]
