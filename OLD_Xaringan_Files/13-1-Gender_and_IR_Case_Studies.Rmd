...
## {background-image="libs/Images/13_1-gender_climate.avif"}

![](libs/Images/13_1-Climate_Change_Gender1.png){.absolute left=0 width="5.3in" height="1.5in"}
...
## Gender Case Studies {background-image="libs/Images/background-worldmap3.png" .center}
...
## Gender Case Studies {background-image="libs/Images/background-blue_cubes_lighter3.png" .center}
...
## Can these models of IR be used to "accurately" explain our cases from today? {background-image="libs/Images/background-blue_cubes_lighter3.png" .center}
...
## How difficult would it be to add a gender dynamic to these theories? {background-image="libs/Images/background-blue_cubes_lighter3.png" .center}
