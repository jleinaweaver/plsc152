...
tribble(
  ...
  column_spec(2, background = c(rep("white", 6), "pink3", "white", "gold")) |>
  column_spec(3, background = c(rep("white", 6), "pink3", "white", "gold"))
```
...
**SLIDE**: Your job is to find us examples of this model in action!
:::
