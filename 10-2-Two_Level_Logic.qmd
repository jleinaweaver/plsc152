...
2. Update slide with current EC points earned from PD v1 to complicate leader's task AND highlight the leader

3. YOU need to decide the leadership rewards!
...
## Prisoner's Dilemma (v2) {background-image="libs/Images/background-worldmap4.png" .center}
