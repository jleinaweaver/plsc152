...
## What Happened? {background-image="libs/Images/background-worldmap4.png" .center}
...
## Explaining the Outcome {background-image="libs/Images/background-worldmap4.png" .center}
...
```{r, fig.align='center'}
knitr::include_graphics("libs/Images/10_2-Mark_Twain_Quote.jpeg")
```
...
## Explaining the Outcome {background-image="libs/Images/10_2-Decision_v2.png"}
...
## Explaining the Outcome {background-image="libs/Images/10-2-How-to-negotiate-a-deal.jpg"}
...
## A Two-Level Prisoner's Dilemma {background-image="libs/Images/background-worldmap4.png" .center}
...
::: {.column width="50%"}
```{r, fig.align='right'}
knitr::include_graphics("libs/Images/10_2-arafat_clinton.webp")
```
:::

::: {.column width="50%"}
```{r, fig.align='right'}
knitr::include_graphics("libs/Images/10_2-patronage_v2.png")
```
:::
::::
...
## Two-Level Games are Everywhere  {background-image="libs/Images/background-worldmap4.png"}
