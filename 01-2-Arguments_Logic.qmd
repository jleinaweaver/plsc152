...
## Assignment for Today {background-image="libs/Images/background-worldmap4.png"  .center}
...
## {background-image="libs/Images/01_2-Girl_yells_yak.jpg"  .center}
...
## To be convincing an argument should be logical, clear, credible and critical {background-image="libs/Images/background-slate_v2.png" .center}
...
## Argument Basics {background-image="libs/Images/background-slate_v2.png" .center}
...
## Inductive Arguments {background-image="libs/Images/background-slate_v2.png" .center}
...
## {background-image="libs/Images/01_2-globe_and_lights.jpg"}
