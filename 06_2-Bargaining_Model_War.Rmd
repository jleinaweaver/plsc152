...
# 650x350
d <- tibble(
  Version1 = c(4, 5, 5, 4, 4, 4, 1, 5, 3), # total 35
  Version2 = c(2, 3, 3, 3, 2, 5, 3, 4, 5), # total 30
  Version3 = c(3, 2, 3, 1, 2, 4, 1, 2, 0), # total 18
  Version4 = c(0, 0, 2, 0, 0, 2, 0, 1, 0) # total 5 
)
...
- 8 pairs fought zero wars in their five rounds together.
...
### At that moment, is there any amount of gold the second pirate could offer the first to avoid him pulling the trigger?
...
.size50[.center[
**When is bluffing a smart tactic for getting what you want in international politics?**
]]
