...
## {background-image="Images/01_1-Iranian_nukes.jpg"}
...
```{r, fig.align='center'}
knitr::include_graphics("Images/01_1-Iran_Nuke_Deal.png")
```
...
## Course Grade {background-image="Images/background-worldmap4.png"}

```{r}
tibble(
  col1 = c("Participation", "Argument Paper 1", "Argument Paper 2", "Argument Paper 3", "Total"),
  col2 = c("", "(Sep 13)", "(Oct 18)", "(Final Exam)", ""),
  col3 = c(rep(25, 4), 100)
) |>
...
## The Attendance Cliff {background-image="Images/background-worldmap4.png"}
...
## Keep me in the loop! {background-image="Images/background-worldmap4.png"}
