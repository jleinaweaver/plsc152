...
## {background-image="libs/Images/05_2-Peer_Review.png"}
...
## Revise and Resubmit Paper 1 {background-image="libs/Images/background-worldmap4.png" .center}
...
## {background-image="libs/Images/11_2-Example-US_China_Trade.png"}
...
```{r, fig.align='left'}
knitr::include_graphics("libs/Images/08-2-trump_trade_war.webp")
```
:::
...
## The Effect? {background-image="libs/Images/background-worldmap4.png" .center}
...
![](libs/Images/11_2-Example-US_China1.png){.absolute left=200 top=0 width="70%"}

![](libs/Images/11_2-Example-US_China2.png){.absolute left=200 bottom=0 width="70%"}
...
## {background-image="libs/Images/background-watercolor_v2.png" .center}
...
## Panagariya (2003) {background-image="libs/Images/background-watercolor_v2.png" .center}
...
## Rodrik (2001) {background-image="libs/Images/background-watercolor_v2.png" .center}
