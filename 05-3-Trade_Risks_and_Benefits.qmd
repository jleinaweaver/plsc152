...
- Is peace worth the costs of embracing the logic of economic liberalism?
...
2. **Save time for END of class to discuss revise and resubmit plan for paper 1**
...
- **How could we explain that event using our theories of international relations? (e.g. neorealism, offensive realism, and economic liberalism)**

<br>

**SLIDE**: Economic liberal model
...
**SLIDE**: Before we wrap today let's talk about the first paper
...
::: {.r-fit-text}
**Revise & Resubmit Paper 1 (Due Feb 20)**
:::
...
Revisions are due next week

- Strike while the content is still fresh in your mind!
