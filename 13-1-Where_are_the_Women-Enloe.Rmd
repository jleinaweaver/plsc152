...
background-image: url('libs/Images/13-1-types-of-maps.jpg')
background-size: 60%
background-position: center
class: middle, slideblue
...
Examples on Slide:
- Some maps track weather patterns,

- Some maps measure elevations,

- Some maps track rail lines and public transit

- Some focus on interstate highways and state capitals,

- Some let us compare characteristics at smaller, e.g. county levels, and

- Some help us navigate the streets around our homes or works.

<br>

The most useful one depends on what you are trying to do or explain in a given moment.
