...
- This week we'll explore feminist models of IR,

- Next week the literature exploring race and international politics.
...
The whole book makes a series of compelling arguments but I think Chapter 1 gives us plenty of material to explore today and sets us up nicely for the rest of the week.

<br>

SLIDE: Let's build up to Enloe's argument



---

background-image: url('libs/Images/13-1-World_Map_Old.jpg')
background-size: 100%
background-position: center

???

### Refresh my memory, what is true about every map you've ever encountered?
...
### So, if all maps are limited in their accuracy why can't we just find the most useful one and drop the rest?
...
background-image: url('libs/Images/13-1-weather_map.webp')
background-size: 100%
background-position: center
...
This is a pretty darn good map for answering the question, is it going to rain?
...
background-image: url('libs/Images/13-1-topo-map.jpg')
background-size: 100%
background-position: center
...
background-image: url('libs/Images/13-1-us_map_population.jpg')
background-size: 75%
background-position: center
...
# Building Models of International Relations
...
The key for us as social scientists seeking to explain international political events is that everything true for maps is also true for the models of IR we've been studying this term.

This semester we've organized our analyses of models using interests, institutions and interactions.

### What do the "interests" refer to?

<br>

### What are the "institutions" we've been exploring?
...
### What are the interests, institutions and interactions in Neorealism?
- Interests: Unitary states seeking security
- Institutions: International Anarchy
- Interactions: Everyone and everything is a threat

### What are the interests, institutions and interactions in Offensive Realism?
- Interests: Unitary states seeking power/regional hegemony
- Institutions: International Anarchy
- Interactions: Everyone and everything is a threat that must be balanced against

### What are the interests, institutions and interactions in Economic Liberalism?
- Interests: States seeking economic growth
- Institutions: International Anarchy
- Interactions:  Institutions can be created to facilitate cooperation and trade transforms societies (specialization)

### What are the interests, institutions and interactions in Constructivism?
- Tougher fit...
- Interests and Institutions are mutually constituted
- Interactions in EVERYTHING
...
Ok, enough preamble, let's dig into the Feminist model discussed in the Enloe chapter.
...
.center[
# What are the key elements of a Feminist model of IR?
]
...
Our goal is to try and diagram this model using our three categories.

Groups, focus just on the individuals in this model.

### Who are the primary actors and what do they want?
...
- Individuals who want... ?
    - Not just a story about women! 
    - It's about remembering women are ALSO important actors
    - 
...
Groups, based on your reading of the chapter, what does the Feminist IR map look like? 

- How does it approach the interests, institutions and interactions we've been using to explore international political events?

<br>

In 15 minutes I want your group's diagram of the Feminist model on the board.
...
background-image: url('libs/Images/13-1-feminist_revolution_banner.png')
background-size: 100%
background-position: center
class: slideblue
...
background-image: url('libs/Images/13-1-women_power_politics.jpg')
background-size: 100%
background-position: center

???

Enloe makes the argument that Feminist IR approaches actually take power more seriously than other models, even the realisms!

### How does she make and support this argument?
- ?
...
background-image: url('libs/Images/13-1-philadelphia-female-anti-slavery-society.jpg')
background-size: 40%
background-position: left
class: middle, slideblue

```{r, fig.align='right'}
knitr::include_graphics('libs/Images/13-1-philadelphia_anti_slavery.jpg')
```

???

Let's examine the cases Enloe uses to illustrate the usefulness of the Feminist approach.

This historical marker commemorates the founding of the Philadelphia Female Anti-Slavery Society in December of 1833. 

While many abolitionist groups already existed at this time, most excluded women in favor of an all male membership.

### Per Enloe, what are the lessons of the First Case: The transatlantic antislavery movement?

<br>

### Are we convinced our other IR models would be less useful explaining this case? Why or why not?
...
background-image: url('libs/Images/13-1-arms_trade_treaty.png')
background-size: 100%
background-position: center

???

### Per Enloe, what are the lessons of the Second Case: The international Arms Trade Treaty?
...
background-image: url('libs/Images/13-1-Times-Square.jpg')
background-size: 100%
background-position: center
class: top, center, inverse, textwhite

.size65[**Beyond the Global Victim (p32-36)**]

???

### How does the key argument in the section "Beyond the Global Victim (32-36)" impact our thinking about international politics?

HUGELY empowering message
