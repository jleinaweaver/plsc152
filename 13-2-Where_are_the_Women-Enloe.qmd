...
- Exploring Critical Theories of IR: Feminist Approaches
...
## Theories of International Relations (so far) {background-image="libs/Images/background-blue_cubes_lighter3.png" .center}
...
## {background-image="libs/Images/13-1-World_Map_Old.jpg"}
...
## {background-image="libs/Images/13-1-weather_map.webp"}
...
## {background-image="libs/Images/13-1-topo-map.jpg"}
...
## {background-image="libs/Images/13-1-us_map_population.jpg"}
...
## "Gender Makes the World Go Round: Where are the women?" {background-image="libs/Images/background-worldmap4.png" .center}
...
**SLIDE**: Let's now make sure we are gappling with the arguments in the chapter!
...
## Where Does Power Operate? (p8-13) {background-image="libs/Images/background-worldmap4.png" .center}

<br>

```{r, fig.align='center'}
knitr::include_graphics("libs/Images/13-1-women_power_politics_v2.png")
```
...
### What is the central argument in this section?
- (We need IR models that take power more seriously!)
...
## Who Takes Seriously the Ideas of Transnational Feminists? (p13-20) {background-image="libs/Images/background-worldmap4.png" .center}

<br>

```{r, fig.align='center'}
knitr::include_graphics("libs/Images/13_2-Equity_Now_March.png")
```
...
### What is the central argument in this section?
- (Gender-focused groups treated as special interests, NOT representative of the broader body politic)
...
## What We Miss: Case Studies (p21-28) {background-image="libs/Images/background-worldmap4.png" .center}

:::: {.columns}
::: {.column width="50%"}
```{r, fig.align='center'}
knitr::include_graphics('libs/Images/13-1-philadelphia-female-anti-slavery-society.jpg')
```
:::
...
```{r, fig.align='center'}
knitr::include_graphics('libs/Images/13-1-arms_trade_treaty.png')
```
:::
::::
...
### What is the central argument in this section?
- (Our lack of gendered lens means we fail to understand many important international political events!)
...
## Where Are the Men? (p28-32) {background-image="libs/Images/background-worldmap4.png" .center}

```{r, fig.align='center'}
knitr::include_graphics("libs/Images/13_2-Stereotypical_gender_roles.jpg")
```
...
### What is the central argument in this section?
- (We misunderstand the role of men just as much as the role of women in international political events due to our failure to adopt a gendered lens.)
...
## Beyond the Global Victim (p32-36) {background-image="libs/Images/13-1-Times-Square_v2.png"}
...
## Do our models need to change or do we need an entirely new model focused on gender and IR? {background-image="libs/Images/background-blue_cubes_lighter3.png" .center}
