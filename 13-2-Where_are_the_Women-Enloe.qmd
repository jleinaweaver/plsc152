...
## "Gender Makes the World Go Round: Where are the women?" {background-image="libs/Images/background-worldmap3.png" .center}
...
## Where Does Power Operate? (p8-13) {background-image="libs/Images/13-1-women_power_politics_v2.png" background-size='85%'}
...
## Who Takes Seriously the Ideas of Transnational Feminists? (p13-20) {background-image="libs/Images/13_2-Equity_Now_March_v2.png"}
...
## What We Miss: Case Studies (p21-28) {background-image="libs/Images/background-worldmap3.png" .center}
...
## Where Are the Men? (p28-32) {background-image="libs/Images/background-worldmap3.png" .center}
