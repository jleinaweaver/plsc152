...
2. *NOTE*: This semester's class has been awful with the autonomy of group work so let's do a version today where you steer more aggressively.
...
![](Images/13-1-Enloe_Book_Cover.jpg){.absolute width="300" bottom=0 left=400}
...
I want us to work through these sections as they collectively make the argument that IR theory is currently doing a bad job explaining a wide range of international political events
...
- **Do Feminist approaches do a better job modeling power than the realisms? Why or why not?**
...
**Ok, last one, what is the central critique of IR theory in this section?**
