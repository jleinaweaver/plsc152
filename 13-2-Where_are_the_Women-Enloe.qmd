...
## What We Miss: Case Studies (p21-28) {background-image="Images/background-worldmap4.png" .center}

:::: {.columns}
::: {.column width="50%"}
```{r, fig.align='center'}
knitr::include_graphics('Images/13-1-philadelphia-female-anti-slavery-society.jpg')
```
:::
...
```{r, fig.align='center'}
knitr::include_graphics('Images/13-1-arms_trade_treaty.png')
```
:::
::::
