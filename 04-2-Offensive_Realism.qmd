...
```{r, fig.align='center'}
knitr::include_graphics('libs/Images/06_1-WW1-2.jpg')
```
...
## Offensive Realism {background-image="libs/Images/05_2-putin_with_gun_v2.png" .center}
...
## Offensive Realism {background-image="libs/Images/background-slate_v2.png" .center}

**Interests**

- Great powers puruising hegemony
...
## Who are the great powers? {background-image="libs/Images/05_2-justice-league2_v1.png" .center}

<br>

1. What are the characteristics of a "great" power?

<br>

2. Give us 8 examples based on your criteria
...
## Criteria to be a Great Power {background-image="libs/Images/05_2-justice-league2_v1.png" .center}
...
## {background-image="libs/Images/05-2-lex_luthor.jpg"}
...
## {background-image="libs/Images/05_2-mearsheimer-quote.jpg" background-size='96%'}
