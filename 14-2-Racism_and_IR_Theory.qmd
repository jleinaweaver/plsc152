...
## Enloe (2014) {background-image="libs/Images/background-blue_cubes_lighter3.png" .center}
...
## Postcolonial Case Studies {background-image="libs/Images/background-blue_cubes_lighter3.png" .center}

What did we learn from our work on Monday?
...
## {background-image="libs/Images/14-1-Race-The-Power-of-an-Illusion_v2.png" .center}
...
## Race in Global Society (p11-16) {background-image="libs/Images/14-1-Race-The-Power-of-an-Illusion_v2.png" .center}
...
## The Fragile States Index {background-image="libs/Images/background-slate_v2.png"}
...
## {background-image="libs/Images/14-1-Fragile_States-US2023.png"}
...
## {background-image="libs/Images/14-1-Fragile_States-US2-2023.png"}
...
## {background-image="libs/Images/14-1-fragility_world_map2023.png"}
...
## "Race and Global Economic Development" (17-22) {background-image="libs/Images/14-1-fragility_world_map2023.png"}
...
## "Race and Security" (22-29) {background-image="libs/Images/14-1-fragility_world_map2023.png"}
...
## What does a postcolonial IR theory emphasize? {background-image="libs/Images/background-worldmap3.png"}
...
## What does this mean for International Relations? {background-image="libs/Images/background-worldmap3.png"}
...
## Henderson's (2013) Argument {background-image="libs/Images/background-slate_v2.png" .center}
...
## Henderson's (2013) Argument {background-image="libs/Images/14-1-FA_Magazines_Old.png"}
...
## Kant's (1798) Plan for Perpetual Peace {background-image="libs/Images/background-slate_v2.png" .center}
...
## Kant and the Nazis {background-image="libs/Images/background-slate_v2.png" .center}
