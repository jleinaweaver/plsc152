...
2. Consider doing this in two groups as a fight again. This was fun last time doing the DPRK battle.
:::
...
### 1) How big a stretch is assuming the US is rationally pursuing gains?

### 2) Is the US freely able to choose between the two options? Why or why not?
...
## Should the US Defund the United Nations? {background-image="libs/Images/background-blue_cubes_lighter3.png" .center}
...
## What PD strategy is in play? {background-image="libs/Images/background-blue_cubes_lighter3.png" .center}
...
## Next Class: Writing Workshop {background-image="libs/Images/background-blue_cubes_lighter3.png" .center}
