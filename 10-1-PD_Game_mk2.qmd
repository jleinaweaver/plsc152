...
1. Reserve the extra room(s) or use Meador Center

2. Print your PD v2 notes
    
3. Record participation points from Canvas

4. Update 8-2 slides with current EC standings
...
6. IMPORTANT: New groups need to mix up the PD v1 groups so the leaders have a harder task distributing points at end. More fun if inequality exists within each group
:::
...
## A Competitive Prisoner's Dilemma {background-image="libs/Images/background-worldmap4.png" .center}
