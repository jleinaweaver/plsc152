...
## {background-image="libs/Images/10_1-Switzerland_Biden_Putin.jpg"}

<p style="color: white;">**Do Audience Costs Matter?**</p>
...
## A Competitive Prisoner's Dilemma {background-image="libs/Images/background-worldmap3.png" .center}
...
```{r, fig.align='center'}
knitr::include_graphics('libs/Images/09_1-voting.png')
```
