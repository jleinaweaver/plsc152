...
## {background-image="Images/10_1-Switzerland_Biden_Putin.jpg"}
...
knitr::include_graphics('Images/09_1-skipper.jpg')
```
:::
::::
...
*Different number of days, consider assigning the Landler 2021 again as an example*
:::
