...
```{r, fig.align='center'}
knitr::include_graphics("Images/06_2-Fearon_Figure1.png") 
```
...
::: {.column width="25%"}
```{r, fig.align='left'}
knitr::include_graphics("Images/05_2-Bbeard_Sword.jpg")
```
:::

::: {.column width="50%"}
```{r, fig.align='center'}
knitr::include_graphics("Images/05_2-treasure.jpg")
```
:::

::: {.column width="25%"}
```{r, fig.align='right'}
knitr::include_graphics("Images/05_2-Pirate2_v2.png")
```
:::
::::
