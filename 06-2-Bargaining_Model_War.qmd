...
```{r, message=FALSE, warning=FALSE, fig.align='center', fig.asp=.38, fig.width=10}
# Plot
d2 %>%
  ggplot(aes(x = Wars)) +
  geom_bar(width = .75) + #, fill = "darkgrey"
...
## Fearon (1995) {background-image="libs/Images/background-worldmap4.png" .center}
...
```{r, fig.align='center'}
knitr::include_graphics("libs/Images/06_2-Fearon_Figure1.png") 
```
...
## Fearon (1995): Key Assumptions {background-image="libs/Images/background-worldmap4.png" .center}
...
## Fearon's Bargaining Model of War {background-image="libs/Images/background-worldmap4.png" .center}
...
::: {.column width="25%"}
```{r, fig.align='left'}
knitr::include_graphics("libs/Images/05_2-Bbeard_Sword.jpg")
```
:::

::: {.column width="50%"}
```{r, fig.align='center'}
knitr::include_graphics("libs/Images/05_2-treasure.jpg")
```
:::

::: {.column width="25%"}
```{r, fig.align='right'}
knitr::include_graphics("libs/Images/05_2-Pirate2_v2.png")
```
:::
::::
...
## Expected Value of War {background-image="libs/Images/background-worldmap4.png" .center}
...
## Why is the model useful? {background-image="libs/Images/background-worldmap4.png" .center}
...
## Fearon (1995): The Argument {background-image="libs/Images/background-worldmap4.png" .center}
...
## Fearon (1995): The Argument {background-image="libs/Images/background-worldmap4.png" .center .smaller}
