...
# Record class data 
# Last time (FA25): 26, 38, 28, 2

## Spring 2026 (10 pairs)
# Wars and number of pennies for the winner
d <- tibble(
  Version1 = c(1, 2, 4, 2, 4, 2, 2, 3, 4, 2), #  26 total 
  Version2 = c(1, 3, 2, 4, 3, 2, 3, 5, 3, 2), #  28 total 
  Version3 = c(1, 3, 2, 1, 3, 2, 2, 1, 2, 4), #  21 total 
  Version4 = c(0, 3, 0, 0, 2, 0, 0, 0, 0, 0) #  5 total 
)
