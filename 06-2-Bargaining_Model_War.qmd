...
## Spring 2025 (13 pairs)
library(tidyverse)

# Record class data 
# Wars and number of pennies for the winner
d <- tibble(
  Version1 = c(4, 4, 1, 5, 4, 5, 4, 3, 5, 4, 3, 3, 3), # 48 total 
  Version2 = c(3, 5, 3, 2, 2, 5, 4, 3, 3, 5, 5, 3, 2), # 45 total 
  Version3 = c(0, 2, 3, 0, 4, 3, 5, 3, 5, 5, 1, 3, 3), # 37 total 
  Version4 = c(0, 0, 0, 0, 1, 0, 0, 4, 1, 2, 4, 0, 1) # 13 total 
)
...
d2 %>%
  ...
  scale_y_continuous(breaks = 0:max(x1$Wars) + 1) +
  geom_hline(yintercept = seq(1, max(x1$Wars) + 1), color = "white")
```
...
labs1 <- c("High Uncertainty (All Hidden)", "Medium Uncertainty (Most Hidden)", "Low Uncertainty (One Hidden)", "No Uncertainty")
