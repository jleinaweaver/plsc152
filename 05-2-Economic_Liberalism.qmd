...
::: {.r-fit-text}
<p style="color: white;">**Liberal Institutionalism (Keohane 1984)**</p>
:::
...
- (*NOTE: Consider NOT showing them the next slide! Encourage them to rely on their notes BUT be willing to answer questions)

<br>

ANNOUNCE: Make sure you cite Keohane (1984) when using this model
...
- Ask yourself, how does the system change if states choose war? How does it change if states choose trade?
...
Let me know if you have questions about the readings or the assignment.
