...
## A Prisoner's Dilemma {background-image="libs/Images/background-cloth_v3.png" .center}
...
## {background-image="libs/Images/07_2-Negotiations_about_Iranian_Nuclear_Program.jpg"}
...
## Building a Model of the Prisoner's Dilemma {background-image="libs/Images/background-cloth_v3.png" .center}
...
## Real-World Prisoner's Dilemmas {background-image="libs/Images/08_2-climate_change_v2.png"}
...
## For Friday: Draft an Outline {background-image="libs/Images/background-blue_triangles.jpg" .smaller}
