...
## Building a Model of the Prisoner's Dilemma {background-image="Images/background-cloth_v3.png" .center}
...
## A Model of the Prisoner's Dilemma {background-image="Images/background-blue_cubes_lighter3.png" .smaller}
