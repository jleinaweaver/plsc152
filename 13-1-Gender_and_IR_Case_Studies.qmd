...
## Gender Case Studies {background-image="Images/background-blue_cubes_lighter3.png" .center}
...
## Theories of International Relations (so far) {background-image="Images/background-blue_cubes_lighter3.png" .center}
...
## Can these models of IR be used to "accurately" explain our cases from today? {background-image="Images/background-blue_cubes_lighter3.png" .center}
...
## How difficult would it be to add a gender dynamic to these theories? {background-image="Images/background-blue_cubes_lighter3.png" .center}
