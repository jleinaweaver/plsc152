...
### Therefore, we cannot usefully explain THESE specific events without the role of gender (e.g. the other theories will fail to explain the outcome)

::: notes

Ok groups, share your events with each other and then build an argument on the board

- The conclusion of that argument is: we cannot usefully explain these specific international political events without analyzing the role of gender
