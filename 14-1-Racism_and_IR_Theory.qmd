...
::: {.column width="50%"}
```{r, fig.align='center'}
knitr::include_graphics('libs/Images/14_1-US_Israel_Iran_Combat_Apr2024.png')
```
:::
...
```{r, fig.align='center'}
knitr::include_graphics('libs/Images/14_1-Haiti_Apr2024.png')
```
:::
::::
...
```{r, fig.align='center'}
knitr::include_graphics('libs/Images/14_1-Haiti_Cholera_UN.png')
```
